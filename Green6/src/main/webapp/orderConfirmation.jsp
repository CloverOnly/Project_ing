...
<%@ page import ="java.util.ArrayList, java.net.URLDecoder, dto.Green, dao.GreenRepository" %>
<%
...
<div class="container py-4">
	...
	<div class="py-5">
		<table class="table table-hover">
			...
			%>
			<tr>
				<td class="text-center"><em><%=green.getName() %></em></td>
				<td class="text-center"><%=green.getQuantity() %></td>
				<td class="text-center"><%=green.getUnitPrice() %></td>
