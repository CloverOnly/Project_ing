...
<nav class="navbar navbar-expand-lg navbar-light py-20">
    <div class="container-fluid d-flex align-items-center">
        ...
        <div class="d-flex align-items-center me-auto">
        	<a href="mainTravel.jsp" class="hd">
            	<img src="https://cdn.pixabay.com/photo/2018/01/31/05/43/web-3120321_1280.png" width="53" height="53" style="vertical-align:middle;">
            	<span style="margin-left:10px;font-size:30px;">GO Travel</span>
            </a>
        </div>
