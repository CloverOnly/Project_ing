...
//addArea.jsp를 쓰기 위한 작업---------------------
	...
	public TravelRepository() {
		Travel travel1 = new Travel("/webtest/image/jp.jpg" ,"T01", "일본(오사카,교토)", 350000);	//164p
		...
		Travel travel2 = new Travel("/webtest/image/ta.jpg", "T02", "대만", 400000);
		...
		Travel travel3 = new Travel("/webtest/image/tw.jpg", "T03", "태국", 623000);
