	...
	<ul class="nav nav-pills">
		<c:choose>
			<c:when test="${empty sessionId}">
				<li class = "nav-item">
					<a class="nav-link" href="<c:url value="/books.jsp"/>">로그인</a>
				</li>
				<li class = "nav-item">
			...
			<c:otherwise>
				...
				<li class="nav-item">
					<a class="nav-link" herf="<c:url value="/member/logoutMember.jsp"/>">로그아웃</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" herf="<c:url value="/member/updateMember.jsp"/>">회원 수정</a>>
				</li>
			</c:otherwise>
		</c:choose>
