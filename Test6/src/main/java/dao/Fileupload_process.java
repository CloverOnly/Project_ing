...
public class Fileupload_process extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        BookRepository create = BookRepository.getInstance();
        
        Book newBook = new Book(bookId, name, author, publisher, category, releaseDate, unitPrice, unitsInStock);
        newBook.setDescription(description);
        newBook.setFilename(filename);
        
//        create.addBook(newBook);
